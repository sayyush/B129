...
public class Arrays04 {
    public static void main(String[] args) {
     ...
     // Ex 1: String bir array olusturnuz 6 eleman ekleyiniz, Yellow'dan onceki elemanlari yazdiriniz
        ...
        for(String w : colors){
            ...
            System.out.println(w);     // // for each loop
        ...
        } // array'lerde length parentezsiz kullanilir
        //2.Yol:
