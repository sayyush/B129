...
public class Arrays05 {
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(arr, Comparator.comparingInt(String::length));  // :: ==> method referencde demek
        System.out.println(Arrays.toString(arr));
        ...
        Arrays.sort(crr, Comparator.comparingInt(String::length).reversed().thenComparing(Comparator.naturalOrder()));// functional programming denir ,lambda denir
        System.out.println(Arrays.toString(crr));
